...
from ehk.common.numerics import adaptive_discrete_sampling
...
from theory.paths import FORCE_LANDSCAPE_OUTPUT
...
if __name__ == "__main__":
    ...
    save_landscape_figure(
        fig,
        FORCE_LANDSCAPE_OUTPUT.resolve() / "figures" / "f_mech_explain_potential",
    )
