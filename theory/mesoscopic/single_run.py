...
from theory.mesoscopic.cli_utils import first_crossing, pathway_label
...
def parse_args() -> argparse.Namespace:
    ...
    output_dir = MESOSCOPIC_OUTPUT.resolve()
    parser.add_argument("--output-dir", type=Path, default=output_dir)
    parser.add_argument("--figure-dir", type=Path, default=output_dir / "figures")
