...
DEFAULT_WORKSPACE = REPOSITORY_ROOT / "run_mech"
DEFAULT_RESULT_DIR = REPOSITORY_ROOT / "fig" / "landscape"
...
# f_supp_mech_map.py, in the same order as works.config.all_scenarios_mech.
